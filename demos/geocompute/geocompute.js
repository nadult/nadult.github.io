...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'geocompute.data';
    var REMOTE_PACKAGE_BASE = 'geocompute.data';
...
Module['FS_createPath']('/', 'diagrams', true, true);
Module['FS_createPath']('/diagrams', 'backup', true, true);
Module['FS_createPath']('/', 'data', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_geocompute.data');

    };
    Module['addRunDependency']('datafile_geocompute.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 1480, "filename": "/diagrams/surface1.xml"}, {"start": 1480, "audio": 0, "end": 6498, "filename": "/diagrams/default.xml"}, {"start": 6498, "audio": 0, "end": 7378, "filename": "/diagrams/foo.xml"}, {"start": 7378, "audio": 0, "end": 9185, "filename": "/diagrams/surface2.xml"}, {"start": 9185, "audio": 0, "end": 10665, "filename": "/diagrams/backup/surface1.xml"}, {"start": 10665, "audio": 0, "end": 11730, "filename": "/diagrams/backup/foo1.xml"}, {"start": 11730, "audio": 0, "end": 13148, "filename": "/diagrams/backup/foo2.xml"}, {"start": 13148, "audio": 0, "end": 18166, "filename": "/diagrams/backup/default.xml"}, {"start": 18166, "audio": 0, "end": 19046, "filename": "/diagrams/backup/foo.xml"}, {"start": 19046, "audio": 0, "end": 20853, "filename": "/diagrams/backup/surface2.xml"}, {"start": 20853, "audio": 0, "end": 160365, "filename": "/data/LiberationSans-Regular.ttf"}], "remote_package_size": 160365, "package_uuid": "7137b352-370e-4ba8-bd63-ec7455e7d403"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 253616,
    DYNAMIC_BASE = 5496496,
    DYNAMICTOP_PTR = 253456;
...
var wasmBinaryFile = 'geocompute.wasm';
...
var ASM_CONSTS = {
  151066: function($0) {var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return allocate(intArrayFromString(reply), 'i8', ALLOC_NORMAL);},  
 183988: function($0, $1, $2) {var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); return 0;},  
 185443: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 186432: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 186525: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 187750: function() {return screen.width;},  
 187777: function() {return screen.height;},  
 187850: function($0) {if (typeof Module['setWindowTitle'] !== 'undefined') { Module['setWindowTitle'](UTF8ToString($0)); } return 0;},  
 188004: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 188170: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
...
var real_dynCall_viffiff = asm["dynCall_viffiff"];
asm["dynCall_viffiff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_viffiff.apply(null, arguments);
};
...
var real_dynCall_viiddii = asm["dynCall_viiddii"];
asm["dynCall_viiddii"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_viiddii.apply(null, arguments);
};
...
var real_dynCall_viiffffff = asm["dynCall_viiffffff"];
asm["dynCall_viiffffff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_viiffffff.apply(null, arguments);
};

var real_dynCall_viiifffiif = asm["dynCall_viiifffiif"];
asm["dynCall_viiifffiif"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_viiifffiif.apply(null, arguments);
};
...
var dynCall_viiffffff = Module["dynCall_viiffffff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_viiffffff"].apply(null, arguments)
};

var dynCall_viiifffiif = Module["dynCall_viiifffiif"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_viiifffiif"].apply(null, arguments)
};
